...
models.\fxnote{discussed in chapter 1. Cite here.}
%A  number of  approaches to reduce  the  computational complexity  of  the  physics-based models  have  been explored  in literature  {[}cite{]}
...
dimension.\fxnote{need to  define `axial' at  the start  of the thesis}  Thus, a
...
% The diffusion of Lithium in the solid  being the rate-limiting step has been the focus of many model order reduction  efforts by circumventing the need for using the PDE.
...
% A Lagrangian-like integral method was also proposed to deal with electrolyte
% and solid-state diffusions, which perform well  only at low C-rates by Smith
% and Wang

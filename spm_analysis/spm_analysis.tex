...
\graphicspath{{spm_analysis/figures/}}
% ----------------------- contents from here ------------------------
...
\input{spm_analysis/electrolyte_inclusion.tex}

\section{Quadratic Approximation of Ionic Spatial Concentration}\label{sec:quadraticapprox}
\input{spm_analysis/quadratic_approximation_ce.tex}

...
\begin{figure}[!htb]
    ...
    \glsfmtshort{spm} models for constant current discharge]{Plots in the left
        ...
        = {z_\text{p2d}} - z_\text{spm} $. In this case, the basic \glsfmtshort{spm} remains quite
...
used for comparison across multiple C-rates. The \gls{soc} error is defined as
\begin{equation}
...
\begin{figure}[!htbp]
    ...
    \caption[The \glsfmtshort{udds} drivecycle profile]{Profile of speed versus time
    for the \glsfmtshort{udds} drivecycle}

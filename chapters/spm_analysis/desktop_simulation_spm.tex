...
afforded by the simulation conditions applicable here.
\begin{varwidth}{\textwidth}
    \begin{enumerate}[topsep=1em,itemsep=0.1ex,partopsep=1em,parsep=1em]
    \item At  equilibrium  initial condition ($t=0$), $c_\text{e}$~is uniform
        over the axial space~$x$, and \vspace*{-0.75em}
...
As seen in \cref{tbl:charSimspmp2d},  even the \emph{combined} CPU time to
...
so that the peak  of the the current profile corresponds  to a discharge current

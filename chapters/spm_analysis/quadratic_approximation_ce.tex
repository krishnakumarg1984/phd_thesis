...
\footnotetext{In  rest  of  the   equations,  explicit  time-dependence  of  the
coefficients  is  dropped  from  the notation.  Similarly,  the  spatio-temporal
dependence of the electrolyte  concentration functions~$c_\text{e,j}$ is omitted
in  those circumstances  where  such explicit  notation is  not  crucial to  the
narrative.}

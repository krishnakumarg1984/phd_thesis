...
\begin{table}[!htbp]
    \small
    \caption[Simulation parameters of  an \glsfmtshort{lco} cell]{Parameters for  isothermal simulation of the
        \gls{p2d} and  \gls{spm} implementations  of an  \gls{lco} cell  (with \ch{LiCoO_2}--\ch{LiC_6} electrode   pair
        and   \ch{LiPF_6}   electrolyte).   Highlighted   entries represent parameters exclusive  to \gls{p2d}
        model. \protect{$j \in \{\text{pos},\text{sep},\text{neg}\}$}.}
    ...
    \begin{threeparttable}
        ...
        \begin{tabular*}{\textwidth}{@{} =P{7.5cm} @{\extracolsep{\fill}} +l +c +r @{}}
            ...
            Electrolyte volume fraction, ${\varepsilon}_j$                                                                                               & \tnote{c}\num{0.385}    & \tnote{c}\num{0.724}                                   & \tnote{c}\num{0.485}    \\

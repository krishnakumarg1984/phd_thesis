...
\begin{table}[!htbp]
    \centering
    \caption[Governing equations and boundary conditions of the \glsfmtshort{dfn} model]{Governing equations and boundary conditions of the \glsfmtlong{dfn} model cast in its \glsfmtlong{p2d} description.}
    \label{tbl:dfneqns}
    \begingroup
    ...
    \begin{tabular*}{\textwidth}{@{} l | c r l r @{}}
        ...
        \vphantom{\diffp{\phi_\slambda}{x}{\mathrlap{\substack{x = x_\text{pos/sep}\\x = x_\text{neg/sep}}}}} \!\!\!\!\!\!\diffp{\phi_\slambda}{x}{\mathrlap{\substack{\!\!\!\!\!x=0\\x=x_\text{tot}}}}\hspace{1mm} &= \frac{\pm I}{\sigma_\efflambda A} \\
        \vphantom{j_\lambda = 2 k_\lambdar \sqrt{c_\text{e}\left(c_\slambdamax - c_\slambdasurf\right) c_\slambdasurf} \sinh \left(\frac{0.5 F}{R T(t)} \eta_\lambda \right)}
        {}&\xdash[1.25em]{}
    \end{aligned}$ &
    $\begin{aligned}
...
\begin{minipage}{\textwidth}
    ...
    \begin{flushleft}
        ...
        $\begin{alignedat}{2}
            ...
            & \text{\textbullet{} } \sigma_\efflambda & & = \sigma_\lambda \varepsilon_\slambda^{brugg},\, D_\sefflambda = D_\slambda e^{\frac{-E_{\text{a},D_\slambda}}{R}\left(\frac{1}{T(t)} - \frac{1}{T_\text{sink}}\right)},\, k_\refflambda = k_\lambdar e^{\frac{-E_{\text{a},k_\lambdar}}{R}\left(\frac{1}{T(t)} - \frac{1}{T_\text{sink}}\right)} \\[0.9em]
        \end{alignedat}$

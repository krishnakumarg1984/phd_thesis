...
\begin{table}[!htbp]
    ...
    \label{tbl:dfneqns}
    \begingroup
    \makeatletter\def\f@size{9.375}\check@mathfonts
...
\begin{minipage}{\textwidth}
    ...
    \begin{flushleft}
        ...
        $\begin{alignedat}{2}
            ...
            & \text{\textbullet{} } \sigma_\efflambda & & = \sigma_\lambda \varepsilon_\slambda^\text{brugg},\, D_\sefflambda = D_\slambda e^{\frac{-E_{\text{a},D_\slambda}}{R}\left(\frac{1}{T(t)} - \frac{1}{T_\text{sink}}\right)},\, k_\refflambda = k_\lambdar e^{\frac{-E_{\text{a},k_\lambdar}}{R}\left(\frac{1}{T(t)} - \frac{1}{T_\text{sink}}\right)} \\[0.9em]
        \end{alignedat}$

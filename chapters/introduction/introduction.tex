...
advantages  such  as   high  energy  density,  long   life-cycles,  low  internal
resistance,  low self-discharge,  long  cycle life,  fast  charge and  discharge
cycles~\cite{Reddy2011,Plett2015}.
%\fxnote{Ragone plot here}.
This makes them the preferred  choice  for storage  and  on-demand  retrieval
of energy  in  modern consumer electronics and~\glspl{xeV}.
...
\begin{figure}[!htbp]
    ...
    \caption[Charge-transfer and basic working mechanism of a Li-ion cell]{Simplified representation of charge-transfer
...
within  the  negative  electrode  microstructure.  During  discharge,  \ch{Li^0}~atoms  diffuse  out of  deep  interstitial  sites  towards  the surface  of  the
...
happens   at   the   surface,   leading    to   the   formation   of   \ch{Li^+}~ions   which   reach   the   negative   electrode   by   passing   through   the

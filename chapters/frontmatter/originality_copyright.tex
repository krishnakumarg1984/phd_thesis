...
\begin{flushright}
        \begin{tabular}{@{}p{.4in}p{2.1in}@{}}
            & \includegraphics[angle=-5,width=0.25\textwidth]{chapters/frontmatter/black_ink_sign_from_jpg}\\[-2em]
            Signed: & \hrulefill \\
...
\begin{minipage}[b]{0.3275\textwidth}
    ...
    \noindent \raggedright \includegraphics[width=\linewidth]{chapters/frontmatter/doclicense-CC-by-nc-nd.pdf}
\end{minipage}
\hfill

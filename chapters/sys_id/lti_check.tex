...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/sys_id/figures/time_invariance.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/sys_id/figures/linearity_proof}

...
\begin{table}[!htbp]
    ...
    \glsfmtshortpl{spm} for 1C~galvanostatic discharge
    ]%
    {%
        Summary of statistics for the percentage absolute error in terminal
        voltage for the basic \glsfmtshort{spm} and the composite
        \glsfmtshort{spm} in constant current 1C~discharge simulations.
    }%
    ...
    \begin{tabular}{@{} l S[table-format=2.2] S[table-format=2.2] S[table-format=1.2] @{}}
        ...
        Mean              & 2.92  & 1.79 & 1.54 \\
        \glsfmtshort{rms} & 3.27  & 2.31 & 1.65 \\
        %
        \bottomrule
    \end{tabular}
\end{table}

...
\Cref{fig:temporalcetfquadratic}   shows  time-evolution   of  ionic
concentrations at the current collector  interfaces of the negative and positive
electrodes for a 1C~discharge. Concentration profiles computed
...
\Cref{tbl:galvanostaticerrormetricsquadtfce} provides a summary of error
...
\input{chapters/sys_id/ce_error_table_const_1c}

...
% As discussed  in \cref{ch:intro}, there  is a  growing need to  replace fossil
% fuel-based vehicles  with cleaner  alternatives wherein  Lithium-ion batteries
% hold  much promise.  The next  generation  of battery  powered vehicles  shall
% require higher  energy density  batteries without compromising  power density.
% Furthermore,  the  costs  of  the  on-board battery  pack  shall  have  to  be

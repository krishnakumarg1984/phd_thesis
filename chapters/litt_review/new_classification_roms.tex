...
real-time  model   with  accuracy  properties  of   full-order  \glspl{pbm}  but
possessing  the  computational  simplicity  of  equivalent-circuit  models  (see
...
Jokar~\etal~\cite{Jokar2016},  Fan~\etal's  review  did  not aim  to  provide  a
...
germane to this  thesis author's central hypothesis (a simple  time domain model
is the key  to large scale deployment  of \glspl{pbm}), that the  author of this

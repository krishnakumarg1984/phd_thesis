...
% \fxnote{``can a simple time  domain model do the  job?''}
...
% \fxnote{enumerate  all  the  desirable characteristics and criterion upon which models are to be evaluated}
...
% \fxnote{Should I  discuss how  they mitigated this?}
...
% \fxnote{can perhaps talk about SPM converted  to equivalent circuit by Prasad in the IEEE conference paper}
...
% \fxnote{have not talked  about SPM inspired eq circuit model.  Is it necessary
% to do so?. How to frame this. There  are a few references that belongs to this
% kind}
...
% \fxnote{need to define `axial' at the start of  the thesis}
...
% \fxnote{does this fit better in the conclusion chapter?}
...
% \fxnote{explain about  Olcer's pseudo-steady state  stuff}.
...
% \fxnote{another method  of  solving  this diffusion is the  integral method analysis used by Tanim  etal. Should I mention that?. There is  also a comprehensive review by Romero  etal. Furthermore, there is a specific review by Zhang and White}
...
% \fxnote{at the end, count  and substitute the canonical number  of parameters here}
...
lumped  representation  of  electrodes  are  referred  to  as  \glsfmtlong{spm}s

...
% contribution   from   all   electrochemical  quantities   in   the   \gls{p2d}
% model.  This  physics-informed   impedance  model  can  be   extended  to  fit
% parameter  values  of  components  in  an equivalent  circuit  model  \eg~  by
% using  a   standard  Levenberg-Marquardt  non-linear  least   squares  fitting

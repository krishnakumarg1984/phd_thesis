...
prior research on which is presented next.

%and is analysed in detail in \cref{ch:spmanalysis}.

\section{Review of Literature on the \glsfmtlong{spm} Family}
...
observability  analysis~\cite{Bartlett2015}.   Owing  to  their  simplicity, 
this author believes that \glspl{spm} hold the highest potential to bring
physics-based models to embedded \glspl{bms}. With this goal  in view, this thesis seeks to
resurrect interest in this field by addressing the recent paucity in fundamental

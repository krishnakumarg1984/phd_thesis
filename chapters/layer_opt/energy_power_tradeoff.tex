...
\begin{figure}[!tbp]
    \centering
    \includegraphics{chapters/layer_opt/figures/energy_vs_powercell}
    \caption[%
...
\begin{figure}[!bp]
    \begin{minipage}[t]{\textwidth}
        \centering
        \includegraphics[trim=4 4 2 4,clip]{chapters/layer_opt/figures/fig_CC_discharge_curves.pdf}

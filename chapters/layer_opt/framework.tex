...
loading. The computation of this $l_\text{ratio}$ parameter is discussed here.
...
exterior dimensions of the pouch are held constant. Furthermore, as explained in
...
when the  number of layers  forming the stack is  varied, this implies  that the
only  quantities that  may  be allowed  to  change are  the  thicknesses of  the

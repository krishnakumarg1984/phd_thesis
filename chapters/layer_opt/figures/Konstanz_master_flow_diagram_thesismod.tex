...
\begin{figure}[p]
    \begin{center}
        ...
        \begin{tikzpicture}[scale=0.78, every node/.style={scale=0.78},node distance = 7mm,>=Stealth,auto,
            ...
            \node [scale=0.8,accnode,diamond,minimum width=28mm,minimum height=28mm,below=of LionSimbaAcc   ,yshift=-4.5mm ] (acctempcheck)             {$ T(t_\mathrm{f})<T_\mathrm {max}$?};
            \node [scale=0.8,accnode,diamond,minimum width=28mm,minimum height=28mm,below=of acctempcheck   ,yshift=-5.4mm ] (accVoltagecheck)          {$ V(t_\mathrm{f})>V_\mathrm {min}$?};
            \node [scale=0.8,accnode,diamond,minimum width=28mm,minimum height=28mm,below=of accVoltagecheck,yshift=-5.9mm ] (accsoccheck)              {$ z(t_\mathrm{f})>z_\mathrm {min}$?};
            ...
            \draw[->] (lionsimbafastchg) -- (tempcheckfastchg) node[left,midway] {\scriptsize results($t\le t_\mathrm{max}$)};
            ...
            \node [sourcesubsetnode,align=left,anchor=north west,xshift=-3mm,yshift=4mm,inner sep=2pt] at (cpavg |- cellmass.south) (listofcps){$c_{_\mathrm{Al}},c_{_\mathrm{pos}},c_{_\mathrm{neg}},c_{_\mathrm{Cu}}$\\$c_{_\mathrm{sep}},c_{_\mathrm{pouch}},c_{_\mathrm{LiPF_6}}$};
            ...
            \node [controlnodeoutput,align=left,below=of cellmass.south west ,xshift=-2.25mm,yshift=0mm,anchor=north west,inner sep=1pt] (computeallmasses){\scriptsize Compute: \\$m_{_\mathrm{Al}},m_{_\mathrm{pos}},m_{_\mathrm{neg}},m_{_\mathrm{Cu}}$\\$m_{_\mathrm{sep}},m_{_\mathrm{pouch}},m_{_\mathrm{LiPF_6}}$};
            ...
            \node[sourcesubsetnode,below =14.9mm of computeallmasses.south west,anchor=center,align=left,minimum width=12mm,xshift=2mm] (constantdomainlengths) {$\scriptstyle{l_\mathrm{Al}}$\\$\scriptstyle{l_\mathrm{sep}}$\\$\scriptstyle{l_\mathrm{Cu}}$};
            ...
            \node[scale=0.9,sourcesubsetnode,yshift=0mm,xshift=2.25mm] at (computeallmasses -| listofcps) (pouchdimensions) {$ L_\mathrm{pouch},W_\mathrm{pouch}$};
            ...
            \node[controlnode,anchor=east,yshift=-0.8mm] at (domainlengths -| scalebydteff.west) (iterativesearch) {\footnotesize Customised  Binary \\\footnotesize Search Algorithm};
            ...
            \node[controlnode,align=center,inner sep=2pt,anchor=east]  at ($(noptfastchg.east)+(28mm,0)$) (exitcondition2) {\scriptsize exit \\ \scriptsize condn.$=2$};

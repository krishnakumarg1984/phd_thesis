...
\begin{figure}[p]
    \begin{center}
        ...
        \begin{tikzpicture}[auto,scale= 0.7, every node/.append style={transform shape},circuit ee IEC]
            ...
            \end{scope}
            \draw [semithick,decorate,decoration={brace,raise=2pt,amplitude=3.5mm},xshift=0pt,yshift=0pt] (cellsinmodule.south west) to node[rotate=0,yshift=0mm,xshift=-5mm, text width=30mm] {12 identical series-connected batteries per module} (cellsinmodule.north west);

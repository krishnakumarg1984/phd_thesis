...
\begin{table}[!htbp]
    ...
    \begin{threeparttable}
        ...
        \resizebox{\textwidth}{!}{%
            \begin{tabular}{@{} l S[table-format=4.0,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.1,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.1,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.2,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.0,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.1,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] S[table-format=4.1,table-space-text-pre=\Tnote{a} ,table-align-text-pre=false] @{}}
                \toprule
        ...
        \begin{tabular*}{\textwidth}{@{} l @{\extracolsep{\fill}} r @{}}
            ...
            Thickness of pos.\ electrode, $l_\text{Al.}$ \si{(m)}                           & \textsuperscript{f}\num{15e-6}   \\
            Thickness of neg.\ electrode, $l_\text{Cu.}$ \si{(m)}                           & \textsuperscript{p}\num{10e-6}   \\

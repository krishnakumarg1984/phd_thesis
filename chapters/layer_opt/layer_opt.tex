...
this thesis author, Krishnakumar Gopalakrishnan.  However, with the exception of
the spectral scheme, for which  Krishnakumar Gopalakrishnan was responsible, and
the zero-dimensional thermal  model for which Ian Campbell  was responsible, the
advancements inherent  to the  enhanced computer software  (LIONSIMBA~v2.0) were
made  in equal  parts by  Krishnakumar  Gopalakrishnan and  Ian Campbell.  These
advancements would not have been  possible without the contributions and support
of Dr.~Davide Raimondo who served as an unofficial supervisor for this work. The
concept  of layer  reconfiguration for  energy  and power  trade-off, the  layer
optimisation framework,  and the  source code  by which  it is  implemented were
co-developed in  equal parts  by Krishnakumar  Gopalakrishnan and  Ian Campbell.
Krishnakumar  Gopalakrishnan was  the major  contributor to  the development  of
the  binary  search  algorithm  and  produced  Figures  {numbers  of  Powertrain
Schematic and Methodology Overview figures go  here}. Ian Campbell was the major
contributor in  the analysis  of results  and produced  Figures {numbers  of any
figures  in  the  RSC  or  JES  papers,  other  than  the  Powertrain  Schematic
and  Methodology Overview}.  Parvathy Chittur  Subramanianprasad contributed  by
developing the analytical expression for  the maximum possible number of layers,
$n_\text{max}$.}}

...
%contribution to the art. %Describe briefly  the process of mapping a real-world
%cell onto the standard \gls{p2d} model. %Note: Northrop to EV mapping code
...
%range) In  particular, explain how the  critical computation of 60  Ah capacity
%was done. Furthermore, convincingly explain how a pouch cell thickness of 10 mm

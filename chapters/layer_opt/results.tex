...
\footnote{As an accompaniment to this chapter, an open-source software toolbox for optimal layer selection in pouch cells \viz~\gls{bold} is made available for download from GitHub. \\ \mbox{\href{https://github.com/ImperialCollegeESE/BOLD_Toolbox}{\includegraphics [width=0.025\textwidth]{github.pdf}}} \url{ https://github.com/ImperialCollegeESE/BOLD_Toolbox}}
...
\begin{figure}[p]
    \begin{minipage}[t]{\textwidth}
        ...
        \mpfootnotes[1]
        \footnote{The heatmaps in this figure were created by \mbox{Ian D.\ Campbell} who asserts copyright,

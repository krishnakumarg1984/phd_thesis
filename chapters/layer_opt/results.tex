...
its inherent assumptions discussed thus far. Presently, the value added
...
which is immediately available for download and use by relevant stakeholders. This author
...
\SI{43.13}{\kilo\watt} and \SI{26.03}{\kilo\watt}  respectively. The discharging
and charging powers experienced by the  pack during acceleration and fast charge
are significantly higher as seen below.

Considering  the acceleration  parameters in~\cref{tbl:CommonVehicleParams}  for

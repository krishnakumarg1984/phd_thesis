...
(co-created with \mbox{Ian D.\ Campbell} and \mbox{Davide M.\ Raimondo}) for
optimal layer selection in pouch cells \viz~\gls{bold} is made available for
download from GitHub. \\
\mbox{\href{https://github.com/ImperialCollegeESE/BOLD_Toolbox}{\includegraphics[width=0.025\textwidth]{chapters/layer_opt/figures/github.pdf}}} \url{ https://github.com/ImperialCollegeESE/BOLD_Toolbox}}
...
\mbox{\href{https://github.com/lionsimbatoolbox/LIONSIMBA}{\includegraphics[width=0.025\textwidth]{chapters/layer_opt/figures/github.pdf}}} \url{
...
\begin{figure}[p]
    \begin{minipage}[t]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/layer_opt/figures/fig_generate_heatmap_BEV}
        ...
        \vspace*{\floatsep}
        \includegraphics[width=\textwidth]{chapters/layer_opt/figures/fig_generate_heatmap_PHEV}
...
\begin{figure}[!bp]
    \begin{minipage}[t]{\textwidth}
        \centering
        \includegraphics[width=0.998046875\textwidth,trim=4 2 3 4,clip]{chapters/layer_opt/figures/fig_capacity_quadrants.pdf}
        \captionsetup{labelsep=note}
        \caption[

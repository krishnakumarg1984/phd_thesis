...
parameterisation requirements is provided here.
\begin{enumdescriptnum}[leftmargin=!,itemsep=1ex,labelwidth=\widthof{$\symbfit{\text{brugg}_j}$
    ab}
    ]

\item[$\symbfit{\text{brugg}_j} (\times 3)$]   The   empirical  Bruggeman   coefficient
    helps  to  define  the  effective values  of  conductivity  and  diffusivity
    of   the  electrolyte.   Although  an   identical   value  of   4  is   used
    in~\cref{tbl:solidphaseapprox},  in principle  all  three  regions can  have
    different values of brugg and need to be parametrised separately.

\item[$\symbfit{D_j} \\ (\times 1)$] The  intrinsic electrolyte  diffusivity of  a typical
    ...
    region within the cell, this can be counted as a single parameter.

\item[{\parbox[t]{7cm}{ first line \setstretch{1.0} \\ \centerline{second line}}}] more explanation
\item[{\begin{varwidth}[t]{2cm} Mary \setstretch{1.0} \\
    \centerline{hello} \end{varwidth}}] more explanation jdk hkjhgf jsdfj hgdsfj
    hkjfdhg kjhgfds kjf hgfdj jdg jdgjh gkjhfdgkj dj fdjhg jhgjh jhgfdkjh gjh jh
    gfjh gjhf jhgfkjhd gjhfdgjhdgdshgf jhgfds khgjfdsbfjhsbjhgsbfd jgbsjh bjhdb
    gjhbdskjgbf kjbgjh fbsjdbjbgjh bfdgj
% \item[\begin{customenum}{Kerala is God's own country}{3} \end{customenum}] more explanation
% \item[\customenum{Kerala is God's own country}{3}] more explanation

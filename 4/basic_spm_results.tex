...
%     $\makecell[tl]{\symbfit{\text{brugg}_j} \\ (\times   3)}$  &   The  empirical
%     Bruggeman coefficient helps  to define the effective  values of conductivity
%     and diffusivity of the electrolyte. Although an identical value of 4 is used
...
%     \customenum{D_j}{1}  & The  intrinsic electrolyte  diffusivity of  a typical
...
% \end{tabularx}
\begin{enumdescriptnum}[leftmargin=!,itemsep=1ex,labelwidth=\widthof{$\symbfit{\text{brugg}_j}\, \scriptstyle (\times 3)\qquad$}
    ,partopsep=0pt
    ,topsep=0pt
    ]

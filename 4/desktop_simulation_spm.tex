...
%     \centering
%     \def\svgwidth{8cm}
%     \includegraphics[width=0.95\textwidth]{4/TikzPictures/example1.tikz}
...
\begin{figure}[htbp]
    \centering
    % \includegraphics[width=\textwidth]{4/TikzPictures/m2t_kappa_ce_T.tikz}
    % \includegraphics[width=\textwidth]{4/TikzPictures/example1.tikz}

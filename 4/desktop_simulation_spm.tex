...
\begin{figure}[!htb]
    ...
    constant current discharge]{Voltage responses of \glsfmtshort{p2d} and
        ...
        performance of the \glsfmtshort{spm} degrades considerably above C-rates
    of 0.5C.}
...
The column to the right shows
the percentage  error in the voltage  response of the \gls{spm}  with respect to
the \gls{p2d} model.

At very low C-rates below \approx 0.5C, the
voltage-response performance of the \gls{spm} is acceptable.

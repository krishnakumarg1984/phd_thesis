...
\begin{figure}[!htb]
    ...
    from this characterisation run is shown in~\cref{tbl:charSimspmp2d}.}
...
was  performed. If  the  assumed cell  capacity is  indeed  consistent with  the
model  parameters,  then  this  corresponds   to  a  C-rate  of  \sfrac{1}{100},
and  the  \gls{p2d}  and  \gls{spm}   should  run  for  exactly  \SI{100}{\hour}
before charge  depletion cut-off.  For accurate  coulomb counting,  data logging
rate  is  set  to  \SI{50}{\milli\second}.  \Cref{fig:capcharspmp2d}  shows  the
voltage  response   of  the  \gls{spm}   and  \gls{p2d}  models   obtained.  The
...
\begin{table}[!htb]
    ...
    \caption{hello}\label{tbl:charSimspmp2d}
\end{table}

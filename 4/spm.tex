...
A   naive   approach   to    numerically   solving   the   solid-phase diffusion
equation~(\ref{eq:csdiffusionfinal})   is  to   discretise  each   of the   two
representative  particles in  the  radial direction as shown
in~\cref{fig:radialdiscretisation}.
thus obtaining concentric
shells (\ie{} rings in 1 dimension)
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{placeholder_images/example-image-golden.pdf}
    \caption{Radial discretisation of each spherical particle yielding
    concentric shells}

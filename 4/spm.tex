...
electrodes.} The divergence of a vector field $𝐅(r,θ, ϕ)$ can
...
\begin{equation}\label{eq:totallithiummoles}
    n_\text{Li} = \frac{\varepsilon_\spos \, l_\text{pos}\, A}{\frac{4}{3} \pi R_\ppos^3} \int_0^{R_\ppos} 4 \pi r^2 c_\spos(r,t) \, dr
    +  \frac{\varepsilon_\sneg \, l_\text{neg}\, A}{\frac{4}{3} \pi R_\pneg^3} \int_0^{R_\pneg} 4 \pi r^2 c_\sneg(r,t) \, dr
\end{equation}
...
\begin{align}\label{eq:totallithiumsimplified}
    n_\text{Li} &= \frac{\varepsilon_\spos \, l_\text{pos}\, A}{\frac{4}{3} \pi R_\ppos^3}\mean{c}_\spos \int_0^{R_\ppos} 4 \pi r^2  \, dr
    + \frac{\varepsilon_\sneg \, l_\text{neg}\, A}{\frac{4}{3} \pi R_\pneg^3}\mean{c}_\sneg \int_0^{R_\pneg} 4 \pi r^2  \, dr
    \\
    &= \varepsilon_\spos \, l_\text{pos}\, A \, \mean{c}_\spos + \varepsilon_\sneg \, l_\text{neg}\, A \, \mean{c}_\sneg
\end{align}
...
\begin{align}
    0 &= \phantom{+} \diff*{\varepsilon_\spos \, l_\text{pos}\, A \, \mean{c}_\spos }{t} + \diff*{\varepsilon_\sneg \, l_\text{neg}\, A \, \mean{c}_\sneg }{t}
    \\

...
phase diffusion in each electrode.

The mass-balance equation of~\cref{eq:csdiffusioneqn} is driven by the
intercalation flux density at the particle surface, $j_p(x,t)$ which is examined
next.

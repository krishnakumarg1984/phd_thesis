...
\begin{equation}\label{eq:csdiffusionconstdiffusivity}
    \diffp{c_\sj}{t} = \frac{D_\sj}{r^2}\diffp*{\left(r^2 \nabla c_\sj \right)}{r}
\end{equation}
Applying the gradient operator of~\cref{eq:csdiffusionconstdiffusivity} along
the radial direction $r$ results in
\begin{equation}\label{eq:csdiffusionfinal}
    \diffp{c_\sj}{t} = \frac{D_\sj}{r^2}\diffp*{\left(r^2 \diffp{c_\sj}{r} \right)}{r}
\end{equation}
...
\begin{align}
    ...
    in~\cref{eq:csfluxsurface} yields}
    D_\sj\diffp{c_\sj}{r}{r=R_\pj} &= \frac{I}{A l_j a_\sj F}
\end{align}
% \begin{equation}\label{eq:csfluxsurfacefinal}
%     D_\sj\diffp{c_\sj}{r}{r=R_\pj} = \frac{-j_\nj(t)}{a_s F}
% \end{equation}

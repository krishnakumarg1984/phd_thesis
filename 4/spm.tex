...
model dynamics. In extant lithium-ion chemistries, the negative electrode is considered to be the limiting
electrode and is hence used in \gls{soc} estimations. Hence, it is retained in
the state vector. The positive electrode

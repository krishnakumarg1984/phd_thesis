...
\begin{align}
    j_\nj &= j_{0_j} \left[ \exp\left( \frac{\left(1-\alpha\right) F η_j}{R T}\right) -  \exp\left( \frac{-\alpha F η_j}{R T}\right)\right] \label{eq:bvwithalpha} \\
...
\begin{align}
    η_\text{pos} &= \phi_\spos - \cancelto{0}{\phi_\epos} - U_\text{pos} \label{eq:posoverpotential} \\
    η_\text{neg} &= \phi_\sneg - \cancelto{0}{\phi_\eneg} - U_\text{neg} \label{eq:negoverpotential}
\end{align}
...
\begin{align}
    η_\text{pos} - η_\text{neg}  &= \underbrace{\phi_\spos - \phi_\sneg}_{V_\text{cell}} - U_\text{pos} - U_\text{neg}\\
...
\begin{equation}\label{eq:totallithiummoles}
    n_\text{Li} = \frac{ε_\spos \, l_\text{pos}\, A}{\frac{4}{3} \pi R_\ppos^3} \int_0^{R_\ppos} 4 \pi r^2 c_\spos(r,t) \, dr
    +  \frac{ε_\sneg \, l_\text{neg}\, A}{\frac{4}{3} \pi R_\pneg^3} \int_0^{R_\pneg} 4 \pi r^2 c_\sneg(r,t) \, dr
\end{equation}
...
\begin{align}\label{eq:totallithiumsimplified}
    n_\text{Li} &= \frac{ε_\spos \, l_\text{pos}\, A}{\frac{4}{3} \pi R_\ppos^3}\mean{c}_\spos \int_0^{R_\ppos} 4 \pi r^2  \, dr
    + \frac{ε_\sneg \, l_\text{neg}\, A}{\frac{4}{3} \pi R_\pneg^3}\mean{c}_\sneg \int_0^{R_\pneg} 4 \pi r^2  \, dr
    \\

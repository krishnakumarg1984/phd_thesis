...
in~\cref{subsubsec:introblackboxsysid} are only applicable for \gls{lti}
systems. At the first glance, this sounds too restrictive. Lithium ion batteries
exhibit non-linear characteristics, owing to the strong non-linearities in the
Butler-Volmer reaction kinections~\cref{eq:butlervolmer}

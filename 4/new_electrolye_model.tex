...
\begin{figure}[!htb]
    ...
    identification]{Input current profile used as the validation set for system
        ...
        from \SI{100}{\milli\hertz}  all the  way up  to the  Nyquist frequency.
        Its  amplitude variation  across  the frequency  spectrum increases  the
        probability to capture  the system's modes that were  possibly missed by
        the preceding waveforms.
    }%

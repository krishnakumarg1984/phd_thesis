...
\section{Reduced Order Models: A New Classification Scheme}{sec:classificationscheme}
...
about SPM inspired eq circuit model. Is it necessary to do so?}
...
taking into  account the idiosyncrasies of  porous electrodes\todo{explain about
Olcer's  pseudo-steady  state  stuff}.  However,  this  expression  involves  an
...
% models and the rest of this section discusses them in detail.


During     the    initial     years     succeeding     its    inception,     the
formulation     of     the     basic    \gls{spm}     has     been     discussed
extensively    within     application-specific    contexts    such     as    for
\gls{soc}  estimation~\cite{Santhanagopalan2006a,Santhanagopalan2008}, parameter
estimation   studies~\cite{Santhanagopalan2007},    life   cycle    and   ageing
predictions~\cite{Santhanagopalan2008a,Safari2009}.   There   have   also   been
detailed stand-alone presentations  of various facets of the model,  such as its
assumptions  and governing  equations~\cite{Santhanagopalan2006,Chaturvedi2010}.
Owing   to   the    limitations   of   the   basic    \gls{spm}   as   discussed
in~\cref{subsec:basicspmlimitations}, since the turn  of the decade, researchers
have  focussed on  presenting  their  solutions to  these  issues  of the  basic
\gls{spm}.


A   survey  of   recent  literature   in  time   domain  reduced   order  models
indicates  a  declining  interest  in  the  \gls{spm}  family  of  models.  This
trend  could  be   attributed  to  a  general  consensus   within  the  research
community  that  these  models  may  be  too  simplistic  and  not  of  suitable
accuracy   to   warrant  further   studies.   Other   than  a   small   minority
of   papers  that   propose  core   modelling  improvements   to  tackle   their
modelling   inaccuracies   or   add  new   enhancements~\cite{Li2017a},   recent
literature  in  this  family  of  models   only  discuss  the  topics  of  state
estimation~\cite{Chaochun2018}, cycling  performance~\cite{Maia2017} sensitivity
analysis~\cite{} and  parametrisation~\cite{Li2018,Rajabloo2017} rather  than on
and to facilitate online implementation. might be an indicator that the proposed
solutions

The author of this thesis seeks to re

This main innovation proposed by
this thesis,

...
The  rest  of  this  section  discusses  popular  time-domain  models.  After  a
high-level evaluation of their relative merits  and weaknesses, the rest of this
chapter  discusses methodologies  and solutions  that  aim to  address the  gaps
identified in the most promising candidate among these models with the potential
to facilitate  faster adoption of  physics based models in  online applications.
...
fractional  order  derivatives~\cite{Sabatier2015,   Li2017,  Mu2017,  Wang2017}
shall  not  be  discussed.  Other time-domain  simplification  techniques,  such
as  Hilbert-Space representation  and  singular perturbation  were presented  in
Manzie~\eta{}~\cite{Manzie2015}. However,  these authors provide only  a cursory
overview  of  the  art  and  their  presentation  lacks  any  expository  visual
information such as plots of time-domain  evolution of the internal and terminal
variables.  These methods  have  not seen  uptake in  academia  or industry  and
consequently, they shall not be discussed here.

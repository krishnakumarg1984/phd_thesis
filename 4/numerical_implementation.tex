...
\Cref{alg:algorithm1} shows the  sequence of operations in  a desktop simulation
of the continuous time \gls{spm}.

\begin{algorithm}[H]\captionsetup{font=small,labelfont={bf},labelsep=quad}
    \centering
    \begin{algorithmic}[1]

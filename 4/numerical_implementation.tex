...
in~\cref{alg:disctimespm}), a snippet of  MATLAB code clarifying the computation
of  the discrete-time  system  and  input matrices,  $A_d$  and  $B_d$ is  given
in~\MakeLowercase{\cref{codesnippet:computeAdBd}}.  A   full  code   listing  of

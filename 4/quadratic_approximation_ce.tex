...
\end{WithArrows}$% \parbox{3.6cm}{\hfill \refstepcounter{equation}(\theequation)}\label{eq:hello}
\end{varwidth}
\hfill
\begin{minipage}[t]{0.2\textwidth}
    ...
    \end{flushright}
    % \hfill hello
    % \parbox{3.6cm}{\hfill \refstepcounter{equation}(\theequation)}\label{eq:hello}
\end{minipage}

...
\begin{align}
        Q_\text{e,s}(t) &= D_\effs \diffp{c_\essub}{z}{\mathrlap{z=l_\text{s}}} \\
        Q_\text{e,p}(t) &= D_\effp \diffp{c_\epsub}{z}{\mathrlap{z=l_\text{p}}} + (1 - t^0_\text{+}) a_\spsub \int_0^{l_\text{p}} j_\text{p}\, dz
\end{align}

...
\begin{table}[!htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tabularx}{\textwidth}{ l L C R }
            ...
            \rowcolor{imperiallightgray} Electrolyte porosity, ${\varepsilon}_j$                                                 & \tnote{c}\num{0.385}    & \tnote{c}\num{0.724}                              & \tnote{c}\num{0.485}    \\
            ...
            Thickness, $l_j$ (\si{\meter})                                                                                       & \tnote{c}\num{88e-6}    & \cellcolor{imperiallightgray}\tnote{c}\num{25e-6} & \tnote{f}\num{72e-6}    \\
                                         ...
                                         Stoichiometry, 100\% SOC, ${\theta}_{\text{max}_j}$                                     & \tnote{h}\num{0.4955}   & ---                                               & \tnote{h}\num{0.8551}   \\
        ...
        \item[d] Computed at $T_\text{cell} = T_\text{ref} = \SI{298.15}{\kelvin}$ using coefficients from table \rom{2} in Ref.~\cite{Valoen2005} \\
        \item[e] Computed at $T_\text{cell} = T_\text{ref} = \SI{298.15}{\kelvin}$ using coefficients from table \rom{3} in Ref.~\cite{Valoen2005}\\

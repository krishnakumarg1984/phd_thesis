...
\begin{table}[!htbp]
    ...
    \begin{threeparttable}
        ...
        \begin{tabularx}{\textwidth}{ l L C R }
            ...
            \rowcolor{imperiallightgray} Intrinsic electrolyte diffusivity, $D_j$ (\si{\meter\squared\per\second})               & \tnote{d}\num{3.22e-10} & \tnote{d}\num{3.22e-10}                           & \tnote{d}\num{3.22e-10} \\
            \rowcolor{imperiallightgray} Intrinsic electrolyte conductivity, $\kappa_j$ (\si{\siemens\per\meter})                & \tnote{e}\num{26.24e-3} & \tnote{e}\num{328.15e-3}                          & \tnote{e}\num{66.08e-3} \\
            \rowcolor{imperiallightgray} \ch{Li^+} transference number, $t^0_\text{+}$                                           & \tnote{c}\num{0.363}    & \tnote{c}\num{0.363}                              & \tnote{c}\num{0.363}    \\
            \rowcolor{imperiallightgray} Intrinsic electronic conductivity, $\sigma_j$ (\si{\siemens\per\meter})                 & \tnote{c}\num{100.00}   & ---                                               & \tnote{c}\num{100.00}   \\

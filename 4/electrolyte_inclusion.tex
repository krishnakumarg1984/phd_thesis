...
errors during implementation. Finally,  the electrolyte-specific enhancements to
the \gls{spm} are in the  frequency domain, placing further burden, particularly
on  industry   stakeholders  to   accurately  interpret  the   coefficients  for
transforming to a time-domain implementation in an embedded \gls{bms}.

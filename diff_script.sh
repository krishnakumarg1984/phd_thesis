...
latexdiff -c ld.cfg --driver=pdftex --floattype=FLOATSAFE --packages=amsmath,hyperref,siunitx,cleveref,glossaries,chemformula --exclude-textcmd="section,subsection,subsubsection" --verbose --flatten --math-markup=3 --graphics-markup=2 --enable-citation-markup -L submitted_version -L latest_version -p Preamble/ltxdiff_defaultstyle_preamble.tex ../nonflat_submitted/main.tex main.tex > ../diff_head_submitted/diff.tex

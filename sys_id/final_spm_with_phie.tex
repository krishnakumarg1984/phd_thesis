...
\input{sys_id/final_spm_1C_error_table}
...
\input{sys_id/final_spm_udds_error_table}
...
\gls{bms}. This  concludes the  implementation aspects of  physics-based battery

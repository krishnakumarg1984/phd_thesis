...
Thus, as per the adopted scheme~\cref{eq:electrolytepdwithce} gets modified as
\begin{align}
...
\end{align}
wherein  the time-dependent computations are explicitly shown in the notation.

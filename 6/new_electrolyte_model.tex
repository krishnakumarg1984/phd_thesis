...
\begin{enumerate}
    ...
    \item Apply a third input profile $I_3(t) = \alpha I_1(t) + \beta I_2(t)$ so as to obtain a third set of outputs $\widetilde{Q}_{\text{e,n}_3}\!(t)$ and $\widetilde{Q}_{\text{e,n}_3}\!(t)$.

...
\input{6/intro_to_newelec_model_chapter}
...
\input{6/black_box_sysid_overview}

\section{Introduction to Electrolyte Time-Evolution Subsystems}\label{sec:introtoplant}
\input{6/intro_time_evolution_subsys}

\section{Design of Persistent Excitations}
\input{6/persistent_excitation}

\section{Investigation of Linearity and Time Invariance}\label{sec:lticheck}
\input{6/lti_check}

\section{Transfer Function Identification Procedure}\label{sec:actualsysid}
% \subsection{Identification Methodology and Governing Equations}

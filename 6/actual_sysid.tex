...
For  robustness  against estimation  bias,  instead  of the  standard  \gls{ols}
estimates,  the   \gls{iv}  estimation  method   is  commonly  used   in  system
identification  tasks~\cite{Ljung1999}. Applying  this  to  the \gls{arx}  model
structure, two deterministic model order criteria have been defined ---
\begin{enumerate*}[label=\emph{\alph*})]
    \item \gls{aic}, and
...
is  obtained   by  minimizing   the  modified   log  likelihood   cost  function
\begin{equation}

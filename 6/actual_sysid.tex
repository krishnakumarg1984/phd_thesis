...
equal owing  to the presence of  the separator). Thus, these  transfer functions
are consistent and hence, deemed to be suitable for representing the electrolyte

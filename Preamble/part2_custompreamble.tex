...
\renewcommand{\gitMarkFormat}{\color{imperialbrick} \footnotesize}
\renewcommand{\gitMark}{Git Branch: \gitBranch \textbullet{}\, Commit SHA: \textbf{\gitAbbrevHash{}} \textbullet{}\, Commit Date:\gitReln{} (\gitAuthorDate) \\ }
...
\newcommand{\customenum}[2]{
\item[$\symbfit{#1}\, \scriptstyle (\times #2)$]
}

...
\usepackage{flafter}
\usepackage[bottom]{footmisc} % typically for thesis use;
...
\usepackage[nottoc]{tocbibind} % typically for thesis use; correct page numbers for bib in TOC, nottoc suppresses an entry for TOC itself

...
% \newcommand\blueuline{%
%     \bgroup\markoverwith
%     {\textcolor{blue}{\pgfsetfillopacity{0.2}\rule[-0.5ex]{2pt}{10pt}\pgfsetfillopacity{1}}%
%     }%
% \ULon}

\providecommand{\DIFdel}[1]{{\reduline{#1}}} %DIF PREAMBLE
% \providecommand{\DIFadd}[1]{{\blueuline{#1}}} %DIF PREAMBLE
...
%DIF DIFCODE_UNDERLINE
  ...
  moredelim=[il][\reduline]{\%DIF\ <\ }, %DIF PREAMBLE
  % moredelim=[il][\blueuline]{\%DIF\ >\ } %DIF PREAMBLE
} %

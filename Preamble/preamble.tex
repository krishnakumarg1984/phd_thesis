...
\usepackage[no-math,silent]{fontspec} % after graphicx ; no-math option so that math-handling is left to unicode-math; silent to completely suppress all warnings
...
% \setupbibentry{backmatter/thesis_refs.bib}

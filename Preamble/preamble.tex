...
\PassOptionsToPackage{defaultlines=2, all}{nowindow}
...
% \usepackage{fontspec}  % after graphicx and babel; https://tex.stackexchange.com/questions/188222/problem-with-babel-and-fontspec; no-math option (math-handling is left to unicode-math); silent to suppress all warnings (even in log file)

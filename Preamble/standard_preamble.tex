...
\usepackage{ragged2e} %  "The package should therefore be loaded after the body font and size have been established  for example, after font packages have been loaded
...
\setmathfont[range={\mathunder,\triangleq},Scale=MatchUppercase]{Latin Modern Math}

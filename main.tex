...
\makeglossaries % must be before starting to define any entries for the glossary. And, all glossary definitions must come before this.
\loadglsentries{0_frontmatter/acronyms}
\includeonly{%
    1/chapter1,
    2/chapter2,
    3/chapter3,
...
\printglossary[type=acronym,title={List of Acronyms}]\label{ch:glossary}
...
\include{4/chapter4} % Improved DRA
\include{5/chapter5} % Analysis of SPM
\include{6/chapter6} % New Electrolye Model

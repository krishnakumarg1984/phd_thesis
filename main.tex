...
\input{1/chapter1} % Introduction (to do later)
\input{2/chapter2} % Literature Review
\input{3/chapter3} % Layer Optimisation
\input{4/chapter4} % Improved DRA
\input{5/chapter5} % Analysis of SPM
\input{6/chapter6} % New Electrolye Model

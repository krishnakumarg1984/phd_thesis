...
\begin{landscape}
    ...
    \begin{footnotesize}
        ...
        \begin{longtable}[c]{@{} l  l p{7.5cm} l c c p{1.6cm} @{}}
            ...
            \toprule
            \multicolumn{1}{c}{\makecell{Page \\ no.}} & \makecell{Usage in \\ thesis} & \makecell{Source \\ \vphantom{of work}} & \makecell[l]{Copyright holder \& \\ contact (organisations only)} & \makecell{Date of last \\ correspondence} & \makecell{Have \\ permission?} & \makecell{Permission \\ remarks} \\
            \midrule
            \endfirsthead

...
\includepdf[link, pages=-, pagecommand={\thispagestyle{plain}}]{frontmatter/coverpage.pdf}
...
\printunsrtglossary[type=symbols, title={List of Symbols}, style=listgroup]\label{ch:symbols}

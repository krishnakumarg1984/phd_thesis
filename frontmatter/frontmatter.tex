...
\thispagestyle{plain} % empty
\mbox{}
\includepdf[link, linkname=acknowledgements, addtotoc={1,chapter,0,Acknowledgements,acknowledgements}, pages=-, pagecommand={\thispagestyle{plain}}]{frontmatter/acknowledgements.pdf}

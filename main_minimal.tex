...
% \pdfbookmark[section]{\contentsname}{toc} % with bookmark package. https://tex.stackexchange.com/questions/65544/how-to-link-table-of-contents-in-thesis-pdf % \pdfbookmark[<level>]{<title>}{<dest>}
% % \addtocontents{toc}{\protect{\pdfbookmark[1]{\contentsname}{toc}}} % https://tex.stackexchange.com/questions/1820/contents-in-pdf-bookmarks
...
% \begingroup
% \parskip=0pt
% % \tcblistof[\chapter*]{mypyg}{List of Program Code}  % for minted/tcolorbox algorithms and code
% \endgroup
% \cleardoublepage
\glsresetall
% \begingroup
...
% % \printglossaries
\printglossary[type=acronym,title={List of Acronyms},nonumberlist,style=super]\label{ch:glossary} % basic style

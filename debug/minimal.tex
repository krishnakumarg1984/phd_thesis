...
\newtcbinputlisting[use counter=filePrg,number within=section,list inside=mypyg]{\matlabcodelisting}[3][]{%
    ...
    breakable,
    drop fuzzy shadow,
    minted options={fontsize=\footnotesize,breaklines,autogobble,linenos,numbersep=3mm,mathescape,breakanywhere=true},
    % colback=offwhite,
    colback=white,
...
\matlabcodelisting[SPM Implementation Example in MATLAB]{matlab_codes/cts_time_spm_simulation.m}{sc:spm}

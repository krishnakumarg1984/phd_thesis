...
% \begin{table}[!htbp]
    \begin{table}[p]
        ...
        \begin{threeparttable}
            \begingroup
            \makeatletter\def\f@size{10.5}\check@mathfonts
            ...
            \end{aligned}$ &
            $\begin{aligned}
        c_\text{e}\Bigr\rvert_{\mathrlap{x=l^{-}_\text{neg}}}\hspace{1mm} &= c_\text{e}\Bigr\rvert_{\mathrlap{x=l^{+}_\text{neg}}},\\
        % \vphantom{\diffp{\phi_\text{e}}{x}{\mathrlap{x = 0}}} \phi_\text{e}\Bigr\rvert_{\mathrlap{x=l_\text{tot}}} \hspace{1mm}&= 0 \\
...
\begin{minipage}{\textwidth}
    ...
    \begin{flushleft}
        ...
        $\begin{alignedat}{2}
            & \text{\textbullet{} } c_\text{e} & & \coloneqq c_\text{e}(x,t),\, \phi_\text{e} \coloneqq \phi_\text{e}(x,t) \qquad \big\{\, x \in [0,l_\text{tot}],\, (x=0)\symbol{"2259} \text{\footnotesize neg/Cucc},\, (x=l_\text{tot})\symbol{"2259} \text{\footnotesize pos/Alcc}\, \big\} \\ % \tnote{\dagger} \\
        ...
        $\begin{alignedat}{2}
            ...
            & \text{\textbullet{} } \phi_\slsub & & \coloneqq \phi_\slsub(x_l,t),\, j_l \coloneqq j_l(x_l,t) \qquad \big\{\, x_l \subset x, \, x_\text{neg} \in [0,l_\text{pos}],\, x_\text{pos} \in [l_{\text{pos}+\text{neg}},l_\text{tot}]\, \big\} \\[0.7em]

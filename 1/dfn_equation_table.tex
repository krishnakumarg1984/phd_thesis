...
\begin{table}[p]
    ...
    $\begin{aligned}
        ...
        \vphantom{j_\lambda = 2 k_\lambdar \sqrt{c_\text{e}\left(c_\slambdamax - c_\slambdasurf\right) c_\slambdasurf} \sinh \left(\frac{0.5 F}{R T(t)} \eta_\lambda \right)} \refstepcounter{equation}(\theequation) \\
    \end{aligned}$ \\
    \bottomrule
\end{tabular*}
\endgroup

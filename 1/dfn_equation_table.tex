...
\begin{table}[p]
    \centering
    \caption[]{Governing Equations and Boundary Conditions of the \glsfmtlong{dfn} model}
    \label{tbl:dfneqns}
    \begingroup
    ...
    \end{aligned}$ \\
    % \cmidrule{1-5}
    % \multicolumn{1}{l |}{\multirow{10}{*}{\rotatebox[origin=c]{90}{\makecell{\footnotesize Separator\\ \scriptsize $\lambda \in \{\text{sep}\}$}}}} &
